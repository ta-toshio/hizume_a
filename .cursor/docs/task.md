...
- [ ] **Day 1-2**: Godotプロジェクト作成、ディレクトリ構成設計
- [ ] **Day 3-4**: データスキーマ（モデル）の実装
  - [ ] `StatBlock` クラス（主要ステータス、補助ステータス）
  - [ ] `Horse` クラス
  - [ ] `Equipment` クラス
  - [ ] `Skill` クラス
- [ ] **Day 5**: JSONパーサーとデータローダーの実装

### Week 2: 状態管理と基本ロジック
- [ ] **Day 1-2**: ゲームステート管理システム実装
  - [ ] `GameManager` シングルトン設計
  - [ ] `TrainingState` 管理クラス
- [ ] **Day 3-5**: 育成周期の基本ロジック
  - [ ] ターン制御
  - [ ] 状態変数の更新処理
